    ...
    <div className="h-full w-full bg-zinc-800 flex flex-col overflow-x-hidden">
      ...
      <div className="2xl:pl-80 xl:pl-64 lg:pl-52 md:pl-40 sm:pl-24 pl-12 items-center bg-white justify-between py-32 gap-4 2xl:flex 2xl:flex-row grid grid-cols-1">
        <div className="flex flex-col">
          <p className="text-zinc-800 font-bold 2xl:text-7xl xl:text-6xl text-5xl">Танд зориулсан</p>
          <p className="text-zinc-800 font-bold 2xl:text-7xl xl:text-6xl text-5xl">шинэ үеийн</p>
          <p className="text-zinc-800 font-bold 2xl:text-7xl xl:text-6xl text-5xl">банк</p>
          ...
          <div className="h-12 w-20 rounded-xl border-[1px] mt-12 border-zinc-200 stroke-black flex items-center justify-center cursor-pointer hover:bg-emerald-400 group hover:border-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 group-hover:stroke-white stroke-black">
      ...
      <div className="w-full flex items-center bg-zinc-700 flex-row justify-between xl:2xl:py-44 sm:lg:py-32 py-20 gap-4 2xl:flex 2xl:flex-row grid grid-cols-1 2xl:pl-12 xl:pl-64 lg:pl-52 md:pl-40 sm:pl-24 pl-12 justify-center">
        ...
        <div className="flex flex-col ml-8">
          <p className="text-white font-bold 2xl:text-7xl xl:text-6xl text-5xl">Бид бизнесүүдээ ч</p>
          <p className="text-white font-bold 2xl:text-7xl xl:text-6xl text-5xl">мартаагүй</p>
          ...
          <div className="h-12 w-20 rounded-xl border-[1px] mt-12 border-zinc-600 stroke-black flex items-center justify-center cursor-pointer hover:bg-emerald-400 hover:border-0 group">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-white group-hover:stroke-black">
            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
            </svg>
          </div>
        </div>
