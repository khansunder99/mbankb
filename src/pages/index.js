...
export default function Home() {
  ...
  return (
    <div className="h-full w-full bg-zinc-800 flex flex-col overflow-x-hidden">
      ...
      <div className="w-full h-full 2xl:items-center xl:items-center lg:items-center md:items-center justify-center flex cursor-pointer relative">
        <img
          src="https://m-bank.mn/icons/landing/cashback_cover.png"
          className="object-cover 2xl:block xl:block lg:block md:block hidden"
        ></img>
        <img
          src="https://m-bank.mn/icons/landing/cashback_cover_mobile.png"
          className="object-cover 2xl:hidden xl:hidden lg:hidden md:hidden block"
        ></img>
        <img
          src="https://m-bank.mn/icons/landing/savings_cashback.png"
          className="animate-slideright 2xl:w-1/3 xl:w-1/3 lg:w-1/3 md:w-1/3 2xl:mt-0 xl:mt-0 lg:mt-0 md:mt-0 2xl:ml-[600px] xl:ml-[525px] lg:ml-[450px] md:ml-[350px] w-4/5 sm:mt-[800px] mt-[500px] absolute"
        ></img>
      </div>

      <div className="2xl:pl-80 xl:pl-64 lg:pl-52 md:pl-40 sm:pl-24 pl-12 items-center bg-white justify-between py-32 gap-4 2xl:flex 2xl:flex-row grid grid-cols-1">
        <div className="flex flex-col animate-slideleft">
          <p className="text-zinc-800 font-bold 2xl:text-7xl xl:text-6xl text-5xl">
            Танд зориулсан
          </p>
          <p className="text-zinc-800 font-bold 2xl:text-7xl xl:text-6xl text-5xl">
            шинэ үеийн
          ...
          <p className="text-zinc-400 mt-12 2xl:text-lg text-md">
            Банкны салбар хаах цагийг мэдэх шаардлагагүй.
          </p>
          <p className="text-zinc-400 2xl:text-lg text-md">
            Санхүүгийн бүх үйлчилгээг зайнаас аваарай.
          </p>
          <div className="h-12 w-20 rounded-xl border-[1px] mt-12 border-zinc-200 stroke-black flex items-center justify-center cursor-pointer hover:bg-emerald-400 group hover:border-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke-width="1.5"
              stroke="currentColor"
              class="w-6 h-6 group-hover:stroke-white stroke-black"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <img
          className="rounded-md 2xl:w-3/5 w-4/5 mr-8"
          src="https://m-bank.mn/icons/landing/landing_3.png"
        ></img>
      </div>

      <div className="w-full flex items-center bg-zinc-700 flex-row justify-between xl:2xl:py-44 sm:lg:py-32 py-20 gap-4 2xl:flex 2xl:flex-row grid grid-cols-1 2xl:pl-12 xl:pl-64 lg:pl-52 md:pl-40 sm:pl-24 pl-12 justify-center">
        <img
          className="rounded-md 2xl:w-3/5 w-4/5 order-last 2xl:order-first 2xl:mt-0 mt-8"
          src="https://m-bank.mn/icons/landing/landing_2.png"
        ></img>
        <div className="flex flex-col ml-8">
          <p className="text-white font-bold 2xl:text-7xl xl:text-6xl text-5xl">
            Бид бизнесүүдээ ч
          </p>
          <p className="text-white font-bold 2xl:text-7xl xl:text-6xl text-5xl">
            мартаагүй
          </p>
          <p className="text-zinc-400 mt-12 xl:2xl:text-lg sm:lg:text-md text-sm">
            Таны бизнесийг хэнээс ч илүү ойлгож, хамтран ажиллая.
          </p>
          <div className="h-12 w-20 rounded-xl border-[1px] mt-12 border-zinc-600 stroke-black flex items-center justify-center cursor-pointer hover:bg-emerald-400 hover:border-0 group">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke-width="1.5"
              stroke="currentColor"
              class="w-6 h-6 stroke-white group-hover:stroke-black"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
      ...
      <div className="w-full bg-zinc-700 flex 2xl:flex-row items-center justify-center flex-col 2xl:gap-0 gap-16 xl:flex-row xl:gap-0">
        <img
