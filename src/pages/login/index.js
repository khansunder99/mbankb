...
export default function Login() {
  ...
  const router = useRouter();
    ...
    return (
      ...
      <div className="flex flex-col items-center justify-center 2xl:w-1/3 w-1/2 h-screen bg-zinc-800 ml-1">
        <div className="flex flex-col">
            <div className="bg-zinc-700 cursor-pointer rounded-lg 2xl:w-96 xl:w-96 lg:w-[368px] md:w-[368px] sm:w-96 w-80 p-1 relative h-[42px] gap-1 cursor-pointer flex flex-row">
            ...
            <p className="text-white 2xl:text-4xl xl:text-4xl lg:text-3xl md:text-3xl sm:text-4xl text-3xl mt-6">Нэвтрэх</p>
            <p className="text-zinc-500 2xl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-sm text-xs mt-6">Байгууллагын интернэт банканд тавтай морилно уу.</p>
            <div className="p-2 mt-8 bg-zinc-600 rounded-lg flex flex-row items-center 2xl:w-96 xl:w-96 lg:w-[368px] md:w-[368px] sm:w-96 w-80">
              <img src="https://e-mbank.mn/icons/ic_user.png" className="w-[16px] h-[20px] ml-2 mt-0.5"></img>
              <input placeholder="Нэвтрэх нэр" className="outline-0 focus:text-white placeholder-zinc-500 bg-zinc-600 ml-4 placeholder:text-sm"></input>
            </div>
            <div className="p-2 mt-4 bg-zinc-600 rounded-lg flex flex-row items-center 2xl:w-96 xl:w-96 lg:w-[368px] md:w-[368px] sm:w-96 w-80">
              <img src="https://e-mbank.mn/icons/ic_password.png" className="w-[16px] h-[20px] ml-2 mt-0.5"></img>
              <input placeholder="Нууц үг" className="outline-0 focus:text-white placeholder-zinc-500 bg-zinc-600 ml-4 placeholder:text-sm"></input>
            ...
            <div className="flex flex-row mt-6 items-center">
                <input type="checkbox" className="w-4 h-4 border-black border-1 bg-zinc-700"></input>
            ...
            <div className="flex flex-row mt-8 ">
              <p className="text-zinc-500 text-xs">Нэвтрэх нэр, нууц үгээ мартсан бол</p>
              <p className="text-blue-400 px-1 cursor-pointer text-xs"> Энд </p>
              <p className="text-zinc-500 text-xs"> дарж сэргээнэ үү.</p>
            </div>
        </div>
      </div>
      </div>
