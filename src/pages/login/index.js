...
export default function Login() {
  ...
  const router = useRouter();
    ...
    return (
      <div className="w-full h-full flex flex-row bg-white dark:bg-zinc-800 justify-center overflow-x-hidden">
      ...
      <div className="flex flex-col items-center justify-center 2xl:w-1/3 w-1/2 h-screen dark:bg-zinc-800 bg-white ml-1">
        <div className="flex flex-col">
            ...
            <p className="dark:text-zinc-500 text-slate-600 2xl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-sm text-xs mt-6">Байгууллагын интернэт банканд тавтай морилно уу.</p>
            ...
            <div className="flex flex-row mt-8">
              <p className="text-slate-600 dark:text-zinc-500 text-xs">Нэвтрэх нэр, нууц үгээ мартсан бол</p>
              <p className="text-blue-600 px-1 cursor-pointer text-xs"> Энд </p>
              <p className="text-slate-600 dark:text-zinc-500 text-xs"> дарж сэргээнэ үү.</p>
            </div>
        </div>
      </div>
      </div>
